...
int32_t main() {
    ...
    while (t--) {
        ...
        while (l < r) {
            if (v1[l] != v1[r]) {
                vector<int> temp1 = v1, temp2 = v1;
                temp1.erase(remove(temp1.begin(), temp1.end(), v1[l]), temp1.end());
                temp2.erase(remove(temp2.begin(), temp2.end(), v1[r]), temp2.end());
                vector<int> rev1 = temp1, rev2 = temp2;
