...
int32_t main() {
    ...
    while (t--) {
        ...
        if (k > 2) {
            ...
            for (int el : v2) {
                auto it = lower_bound(v1.begin(), v1.end(), el);
                if (it != v1.end()) {
                    min_n = min(min_n, *it - el);
                }
                if (it != v1.begin()) {
                    min_n = min(min_n, el - *prev(it));
                }
            }
            cout << min_n << endl;
        }
